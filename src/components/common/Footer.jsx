    ...
    <FooterWrapper>
        ...
        <div className="footer-content text-white d-grid container">
          <div className="footer-item">
            ...
            <p className="para-text">
              ...
              veritatis commodi ipsa iste nemo voluptas aperiam dignissimos
              perferendis aut ex.
            </p>
          </div>
          ...
          <div className="footer-item">
            ...
            <p className="para-text">
              Suscribe our newsletter to get our latest update & news.
            </p>
      ...
      <div className="footer-bottom">
        <div className="container d-flex flex-column text-center">
          <p className="footer-bottom-text text-green">Copyright &copy; 2023 developedbymighty - All rights reserved.</p>
